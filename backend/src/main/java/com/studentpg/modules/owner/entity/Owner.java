...
public class Owner {
    ...
    public Owner(String name, String email, String password, String phone, String role,
                 String profileImageUrl, String profileImagePublicId,
                 boolean emailVerified, String whatsappNumber) {
        this.name = name;
        this.email = email;
    ...
    public Long getResetOtpExpiry() { return resetOtpExpiry; }
    public void setResetOtpExpiry(Long resetOtpExpiry) { this.resetOtpExpiry = resetOtpExpiry; }
    ...
    public Long getLastOtpSentAt() { return lastOtpSentAt; }
    public void setLastOtpSentAt(Long lastOtpSentAt) { this.lastOtpSentAt = lastOtpSentAt; }
    ...
    public Long getOtpWindowStart() { return otpWindowStart; }
    public void setOtpWindowStart(Long otpWindowStart) { this.otpWindowStart = otpWindowStart; }
}